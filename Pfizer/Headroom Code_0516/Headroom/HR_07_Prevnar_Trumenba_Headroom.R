...
library(ggplot2)
  ...
  #read data
  vaccine <- read.csv("D:\\raw\\xfer_May1_2017\\vaccine_doses_output.csv")
  ...
  write.csv(brand_dat,paste("HCP_list_Prevnar_Trumenba.csv",sep=""),row.names = F)
  ...
  write.csv(hcplist2,"hcplist_prevnar_trumenba_0502.csv",row.names = F)  
  saveRDS(hcplist3,"hcplist_prevnar_trumenba.rds")
