...
# For brands sent <=10k emails in 2016, apply 0.3 on brand_trx, 0,1 on market relevance
# For brands sent >10k emails in 2016, apply 0.25 on brand_trx, 0.15 on market relevance
...
# weights is used to allocate scores to brands that sent over 100 emails in 2016
...
# digital_bag <- fread("Z:/Derived/Processed Digital Bag Dataset/digital_bag_score_0503.csv")
