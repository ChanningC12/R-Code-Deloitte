...
%crtCentilesCode(VAL_scored, p_nfo_ind1,weightVar,/PROJECTS/GENWORTH_2016/02_CODES/MODELING/MULTNOM/centiles_rf_internalVars_VAL_NFO.sas);

data VAL_rf_scored_centile;
set VAL_scored;
%include "/PROJECTS/GENWORTH_2016/02_CODES/MODELING/MULTNOM/centiles_rf_internalVars_VAL_NFO.sas";
keep plcy_ref cust_ref nfo_ind score10;
run;
